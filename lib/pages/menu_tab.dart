...
class _ProjectWidgetState extends State<ProjectWidget> {
  ...
  Future<void> _submitApplication(String projectName, String skills, String experience, String telegram) async {
    ...
    if (currentUserEmail != null) {
      ...
      final projectCreatorSnapshot = await FirebaseFirestore.instance
          .collection('projects')
          .where('name', isEqualTo: projectName)
          .get();

      if (projectCreatorSnapshot.docs.isNotEmpty) {
        final projectCreatorName = projectCreatorSnapshot.docs.first['creator'];

        // Создаем запись в коллекции applications пользователя-создателя проекта
